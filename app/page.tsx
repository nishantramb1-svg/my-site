  ...
  return (
    <main className="bg-slate-950 text-white min-h-screen overflow-x-hidden">
      ...
      <div className="fixed inset-0 -z-20">
        ...
        <div className="absolute bottom-0 right-1/4 w-[700px] h-[700px] mesh-gradient rounded-full" />
      ...
      <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="mt-16 flex flex-col sm:flex-row justify-center gap-8 sm:gap-12 text-center"
          >
            {[
